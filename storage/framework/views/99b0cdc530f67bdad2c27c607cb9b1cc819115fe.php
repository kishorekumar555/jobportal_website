...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/jobs.css')); ?>" type="text/css">
</head>

<body>
    <div class="navbar">
        <nav>
        <img class="logo" src="<?php echo e(asset('/logo.png')); ?>">
            <ul>
                <li>Home</li>
                <li>Find Jobs</li>
                <li>About</li>
...
</html><?php /**PATH /home/kishorekumar/Desktop/jobportal_website/jobportal/resources/views/Jobs.blade.php ENDPATH**/ ?>